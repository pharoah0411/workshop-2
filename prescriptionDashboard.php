...
<a href="viewPrescription.php?id=<?= $p['PRESCRIPTION_ID'] ?>&source=<?= $src ?>" style="color:#0066ff;">
<i class="fas fa-eye"></i> View
</a>

<a href="printLabel.php?id=<?= $p['PRESCRIPTION_ID'] ?>&source=<?= $src ?>" style="color:#ff9800; font-weight:bold;">
<i class="fas fa-print"></i> Print
</a>

<a href="editPrescription.php?id=<?= $p['PRESCRIPTION_ID'] ?>&source=<?= $src ?>" style="color:#9c27b0;">
...
<button type="submit" style="background:none; color:#28a745; padding:0; text-decoration:underline;" onclick="return confirm('Mark as Completed?')">Complete</button>
</form>
<?php endif; ?>
...
<input type="hidden" name="prescription_id" value="<?= $p['PRESCRIPTION_ID'] ?>">
<input type="hidden" name="source" value="<?= $src ?>">
<button type="submit" style="background:none; color:#e53935; padding:0; text-decoration:underline;" onclick="return confirm('Delete this prescription? This cannot be undone!')">
Delete
</button>
</form>
