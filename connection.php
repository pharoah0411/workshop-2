...
try {
    ...
    if ($mysql_conn2->connect_error) { throw new Exception($mysql_conn2->connect_error); }
} catch (Exception $e) { $mysql_conn2 = null; }
...
} catch (Exception $e) { $pg_conn = null; }
